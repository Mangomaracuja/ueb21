...
public class Stack<T> {
     ...
     * @throws StackException Exception, wenn Stack bereits voll, da nichts mehr
     * eingefügt werden kann.
     */
    public void push(T t) throws StackException {
        if (full()) {
            throw new StackException(MSG_FULL);
        }
        stack[size] = t;
        size++;
    }
     ...
     * @throws StackException Exception, wenn Stack bereits leer, da nichts mehr
     * entnommen werden kann.
     */
    public T pop() throws StackException {
        if (empty()) {
            throw new StackException(MSG_EMPTY);
        }
        size--;
        T t = stack[size];
        stack[size] = null;
    ...
    /**
     * Methode um das Oberste Objekt im Stack zurückzugeben ohne dieses zu
     * entnehmen.
     *
    ...
    /**
     * Standard toString Methode um den Akutellen Inhalt des Stack
     * zurückzugeben.
     *
